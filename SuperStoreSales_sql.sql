-- Kaggle dan Superstore data seti ile SuperStore Sales ile Data Cleaning ve EDA 
...
-- en çok satış yapılan kategory Tekonoloji
...
group by region
order by sum(sales) desc;
-- en çok satış yapılan bölge 	west

-- en çok satış yapılan şehir-- New York şehri 
